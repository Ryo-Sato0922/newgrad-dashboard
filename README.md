...
- MRR合計 = 商談フェーズが `P7 申込書回収` の企業の `expectedMrr` 合計
- ARPU = `P7 申込書回収企業のMRR合計 / P7 申込書回収企業数`
- ARR見込み = 商談フェーズが `P7 申込書回収` の企業ごとの `想定MRR × 契約期間（月）`
- ARR見込み案件数 = `ARR見込みが1円以上かつP7申込書回収の案件数`
