insert into companies (id, name, industry, owner, email, status, client_phase, na_scheduled_date, deal_memo, expected_mrr, contract_months, success_fee, expected_hires, initial_meeting_date, application_received_date, proposal_date, contract_target_date, contract_start_date, lost_reason, memo, sales_hours, cs_hours, acquisition_cost) values
