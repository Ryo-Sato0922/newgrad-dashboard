insert into companies (id, name, industry, owner, email, status, expected_mrr, contract_months, success_fee, expected_hires, initial_meeting_date, application_received_date, proposal_date, contract_target_date, contract_start_date, lost_reason, memo, sales_hours, cs_hours, acquisition_cost) values
('00000000-0000-0000-0000-000000000001', 'サクラフーズ', '外食', '高橋 美咲', 'misaki.takahashi@sakura-foods.jp', '受注', 320000, 12, 450000, 4, '2026-03-06', '2026-03-24', '2026-03-06', '2026-03-24', '2026-04-01', null, 'リピート勤務者の店長面談化に強い関心。', 26, 18, 210000),
('00000000-0000-0000-0000-000000000002', 'ミナト物流', '物流', '佐藤 蓮', 'ren.sato@minato-logi.jp', '受注', 260000, 12, 400000, 3, '2026-03-10', '2026-04-03', '2026-03-10', '2026-04-03', '2026-04-15', null, '職場体験後の安全理解度と志望度変化を重視。', 22, 15, 180000),
('00000000-0000-0000-0000-000000000003', 'Kanto Retail Partners', '小売', '山本 葵', 'aoi.yamamoto@krp.co.jp', 'PoC', 180000, 6, 350000, 2, '2026-04-02', null, '2026-04-02', '2026-05-25', null, null, '店舗別に職場体験の評価差を見たい。', 19, 11, 150000),
