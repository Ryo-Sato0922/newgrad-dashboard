insert into companies (id, name, industry, owner, email, status, client_phase, forecast_rating, na_scheduled_date, deal_memo, expected_mrr, contract_months, success_fee, expected_hires, initial_meeting_date, application_received_date, proposal_date, contract_target_date, contract_start_date, lost_reason, memo, sales_hours, cs_hours, acquisition_cost) values
('00000000-0000-0000-0000-000000000001', 'サクラフーズ', '外食', '高橋 美咲', 'misaki.takahashi@sakura-foods.jp', '受注', 'P7', '★★★', '2026-03-24', '店長面談化の再現性と初期導入店舗の選定を次回確認。', 320000, 12, 450000, 4, '2026-03-06', '2026-03-24', '2026-03-06', '2026-03-24', '2026-04-01', null, 'リピート勤務者の店長面談化に強い関心。', 26, 18, 210000),
('00000000-0000-0000-0000-000000000002', 'ミナト物流', '物流', '佐藤 蓮', 'ren.sato@minato-logi.jp', '受注', 'P7', '-', '2026-04-03', '安全理解度の変化を資料化し、横展開予算を確認。', 260000, 12, 400000, 3, '2026-03-10', '2026-04-03', '2026-03-10', '2026-04-03', '2026-04-15', null, '職場体験後の安全理解度と志望度変化を重視。', 22, 15, 180000),
('00000000-0000-0000-0000-000000000003', 'Kanto Retail Partners', '小売', '山本 葵', 'aoi.yamamoto@krp.co.jp', 'PoC', 'P3', '-', '2026-05-20', '推進者は合意済み。決裁者向けに店舗別成果の見せ方を整理。', 180000, 6, 350000, 2, '2026-04-02', null, '2026-04-02', '2026-05-25', null, null, '店舗別に職場体験の評価差を見たい。', 19, 11, 150000),
('00000000-0000-0000-0000-000000000004', '東都ホテルズ', 'ホテル', '井上 大地', 'daichi.inoue@toto-hotels.jp', '契約交渉', 'P6', '-', '2026-05-28', '稟議中。価格と開始時期は合意済み。申込書回収日を確認。', 300000, 12, 500000, 5, '2026-04-12', null, '2026-04-12', '2026-06-01', null, null, '接客職の仕事内容理解を上げ、選考辞退を減らしたい。', 24, 12, 190000),
('00000000-0000-0000-0000-000000000005', 'Green Care Works', '介護', '小林 直人', 'naoto.kobayashi@gcw.jp', '提案中', 'P2', '★', '2026-06-05', '課題は明確化中。体験後の不安低減を定量化して提案。', 220000, 9, 420000, 4, '2026-05-02', null, '2026-05-02', '2026-06-20', null, null, '体験前後の心理的ハードル低下を示せると刺さる。', 15, 8, 130000);
...
insert into business_plans (month, target_companies, memo) values
('2026-04-01', 1, 'PoC初月。P7かつ契約開始日ありを実績計上。'),
('2026-05-01', 3, '導入社数の月次予実を確認。'),
('2026-06-01', 6, '10社目標に向けた積み上げ月。');
